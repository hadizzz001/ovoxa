            ...
            <section className="SiteFooter__wrapper" id="footer">
                    ...
                    >
                        <ul>
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.tiktok.com/@ovoxa.beauty"
                                    data-auto-id="true"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.instagram.com/ovoxa.beauty"
                                    data-auto-id="true"
                                    id="page-footer-http-www-instagram-com-bellroy-1"
                                >
                                    <svg
              ...
              C35.3,13.3,35.3,13.3,35.3,13.3z"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.facebook.com/profile.php?id=61578754350420"
                                    data-auto-id="true"
                        ...
                        <div className="text">
                            ...
                            <div className="column">
                                <span className="copyright myWhite">
                                    All rights reserved © {(new Date().getFullYear())} OVOXA Skin Care and Beauty
                                </span>
                            </div>
                        </div>
                    </div>
